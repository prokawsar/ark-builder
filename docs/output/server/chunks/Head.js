...
const Head = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.img === void 0 && $$bindings.img && img !== void 0)
    $$bindings.img(img);
  return `${$$result.head += `<!-- HEAD_svelte-c8ay7v_START -->${$$result.title = `<title>${escape(config.title)}</title>`, ""}<meta name="description"${add_attribute("content", description, 0)}><meta name="author"${add_attribute("content", author, 0)}><meta property="og:url"${add_attribute("content", url, 0)}><meta property="og:type" content="website"><meta property="og:title"${add_attribute("content", title, 0)}><meta property="og:description"${add_attribute("content", description, 0)}><meta property="og:image"${add_attribute("content", img, 0)}><meta name="twitter:card" content="summary_large_image"><meta property="twitter:domain"${add_attribute("content", domain, 0)}><meta property="twitter:url"${add_attribute("content", url, 0)}><meta name="twitter:title"${add_attribute("content", title, 0)}><meta name="twitter:description"${add_attribute("content", description, 0)}><meta name="twitter:image"${add_attribute("content", img, 0)}><!-- HEAD_svelte-c8ay7v_END -->`, ""}`;
});
export {
  Head as H
};
